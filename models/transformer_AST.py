# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 23:04:57 2025
...
# Transformer modeline uygun hale getirme 
...
# Audio Spectrogram Transformer (AST) Modeli
def ats_encoder(inputs, num_heads=4, key_dim=64, ff_dim=256, dropout_rate=0.1):
...
# Her sınıf için TP, TN, FP, FN'yi bulmak
sensitivity = []
specificity = []
